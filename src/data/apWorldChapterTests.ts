...
const mixedReading1: ChapterQuestion[] = [
  readingQuestion(
    ...
    [
      "It spread from a single center after foragers immediately recognized farming as a superior way of life.",
  ...
  readingQuestion(
    ...
    [
      ...
      "stepped royal tombs that preserved a pharaoh's body and guaranteed his passage into the afterlife.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Atman was permanently separate from Brahman, and moksha meant rebirth into a higher caste.",
  ...
  readingQuestion(
    ...
    [
      ...
      "It eliminated the advantages of wealth by giving every boy the same education.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Both borrowed extensively, but Korea did so only after permanent Chinese conquest whereas Japan remained independent.",
  ...
  readingQuestion(
    ...
    [
      ...
      "It consisted chiefly of Arab settlers who displaced Bantu-speaking Africans from the East African coast.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Jesus immediately gained control of the Roman state, while Muhammad deliberately rejected all political authority.",
  ...
  readingQuestion(
    ...
    [
      ...
      "The replacement of money by ritual tribute and the restriction of trade to foreign merchants",
  ...
  readingQuestion(
    ...
    [
      ...
      "Both empires governed indirectly, but the Inca relied somewhat more heavily than the Aztecs on tribute deliveries to their capital.",
  ...
  readingQuestion(
    ...
    [
      "The routes mattered only after European merchants established direct service between China and Rome.",
...
const mixedReading2: ChapterQuestion[] = [
  readingQuestion(
    ...
    [
      ...
      "They were generally mobile and egalitarian, and permanent settlements appeared only after the adoption of agriculture.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Irrigation increased production but depleted rainfall, so farmers adopted barley because it required no water.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Mahayana restricted enlightenment to monks who refused all supernatural assistance.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Foot binding expanded, but this change was fully offset because all women could enter the examination system.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Japan borrowed voluntarily and built a centralized examination bureaucracy even stronger than Song China's.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Trade and diplomacy spread foreign traditions so completely that indigenous languages and beliefs disappeared.",
  ...
  readingQuestion(
    ...
    [
      "The Abbasid caliph continued to appoint every governor from Spain to India after 1200.",
  ...
  readingQuestion(
    ...
    [
      ...
      "It spread only through enslaved captives and had little relationship to commerce or rulers.",
  ...
  readingQuestion(
    ...
    [
      "European commerce was far larger, and a single emperor rewarded merchants with control of rural estates.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Both were created by previously marginal peoples, and their regular diplomatic contact led them to adopt identical systems of tribute government.",
...
const mixedReading3: ChapterQuestion[] = [
  readingQuestion(
    ...
    [
      ...
      "Mobile herding served similar environments, but it had no pre-Columbian counterpart anywhere in the Americas.",
    ],
    "C",
  ...
  readingQuestion(
    ...
    [
      ...
      "Civilizations depended on imported food and therefore had no peasant population.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Both were hierarchical, but India elevated scholar-officials through examinations while China ranked hereditary priests according to ritual purity.",
  ...
  readingQuestion(
    ...
    [
      ...
      "The expansion of printing, which by itself doubled the available food supply",
  ...
  readingQuestion(
    ...
    [
      "Korea adopted an examination system that displaced its aristocracy even more fully than examinations did in China.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Vietnamese elites borrowed Chinese government voluntarily, but no part of Vietnam ever experienced Chinese rule.",
  ...
  readingQuestion(
    ...
    [
      ...
      "The ulama preserved Islamic law, while Sufis opposed all adaptation and therefore rarely attracted converts beyond Arabia.",
    ],
    "C",
  ...
  readingQuestion(
    ...
    [
      ...
      "It severed commercial and diplomatic ties with Constantinople while preserving Norse paganism as the state faith.",
  ...
  readingQuestion(
    ...
    [
      "Chinampas — knotted cords used to record marriages and taxes",
...
const mixedReading4: ChapterQuestion[] = [
  readingQuestion(
    ...
    [
      ...
      "Homo sapiens likely emerged in East Africa about 350,000–260,000 years ago and had occupied every landmass, including Antarctica, by 10,000 BCE.",
  ...
  readingQuestion(
    ...
    [
      ...
      "The flat terrain of Greece produced a single durable empire with no competing cities.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Slavery appeared everywhere in identical form and accounted for one-third of every civilization's population.",
  ...
  readingQuestion(
    ...
    [
      ...
      "It offered a devotional path but insisted that the Buddha could never be incorporated into Hindu belief.",
  ...
  readingQuestion(
    ...
    [
      "It was the first universal missionary religion to convert most of the Roman Empire before Jesus.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Japan created a Chinese-style centralized bureaucracy that permanently eliminated aristocratic families.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Muslim dynasties ruled both regions and converted nearly their entire populations by 1200.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Both grew through trade, but Islam immediately replaced every local language and belief in each region.",
  ...
  readingQuestion(
    ...
    [
      "A single emperor appointed every Maya and Aztec official for two thousand years.",
...
const mixedReading5: ChapterQuestion[] = [
  readingQuestion(
    ...
    [
      "Agriculture caused every community to become a centralized territorial empire.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Every civilization used writing, but some used alphabets rather than pictographs.",
  ...
  readingQuestion(
    ...
    [
      "Buddhism preserved Brahmin ritual authority but rejected karma and rebirth.",
  ...
  readingQuestion(
    ...
    [
      ...
      "defined a faith community but preserved tribe as the only legitimate basis of political allegiance.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Reliance on imported European coal and the abandonment of shipbuilding",
  ...
  readingQuestion(
    ...
    [
      ...
      "It controlled the strait but rejected Indian merchants, Buddhism, and every imported political idea.",
  ...
  readingQuestion(
    ...
    [
      "They restored direct Abbasid control by surrendering all military authority to Arab governors.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Agricultural improvements increased population, but towns, commerce, and intellectual exchange continued to shrink until after 1500.",
  ...
  readingQuestion(
    ...
    [
      "Aztec armies sought to kill every opponent because captives had no religious or political value.",
...
const mixedReading6: ChapterQuestion[] = [
  readingQuestion(
    ...
    [
      ...
      "They relied on persuasion but refused to collect or redistribute goods because economic activity remained entirely private.",
  ...
  readingQuestion(
    ...
    [
      "Mesopotamian farmers prevented salinization, China preserved all old-growth forest, and Europe expanded without erosion.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Theravada emphasized self-effort, while Mahayana kept the same exclusively monastic path and rejected all supernatural helpers.",
  ...
  readingQuestion(
    ...
    [
      "Jesus founded a Roman state church, Paul ended missionary activity, and all Christians remained under one bishop.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Both groups served the same function, enforcing direct Abbasid political rule in every Muslim region.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Song China decentralized into samurai domains, while Japan created the world's most elaborate examination bureaucracy.",
  ...
  readingQuestion(
    ...
    [
      ...
      "Confucian norms changed elite family life, but they immediately transformed peasants and enslaved people to the same degree.",
  ...
  readingQuestion(
    ...
    [
      ...
      "It proves that Indian rulers directly governed mainland Southeast Asia after 1200.",
  ...
  readingQuestion(
    ...
    [
      ...
      "The empire declined after 1200, and its fall immediately erased Orthodox Christianity from every neighboring society.",
    ],
    "C",
  ...
  readingQuestion(
    ...
    [
      ...
      "Women and men had distinct roles, and all work associated with women was legally treated as inferior.",
